...
@section('content')
    ...
    <section class="about-one" style="background-image: url({{ asset('assets/images/shapes/about-1-bg.png') }});">
        <div class="about-one__shape"
            style="background-image: url({{ asset('assets/images/resources/about-shape-1.png') }});"></div>
        <div class="container">
            <div class="row">
                <div class="col-xl-6">
                    <div class="about-one__image wow fadeInLeft" data-wow-delay="300ms">
                        ...
                        <div class="about-one__image__border"
                            style="background-image: url({{ asset('assets/images/shapes/about-1-border.png') }});"></div>
                    ...
                    <div class="row gutter-y-30">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="packages-one__card">
                                ...
                                <h3 class="packages-one__card__title">Abonnement mensuel</h3>
                                <ul class="packages-one__card__list">
                                    <li><span class="fas fa-check"></span>Entretien du réseau</li>
                                    <li><span class="fas fa-check"></span>Changement de l'AP/ Répéteur au besoin</li>
                                    <li><span class="fas fa-check"></span>Gestion de la sécurité du sytème d'information
                                    </li>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="packages-one__card">
                                <div class="packages-one__card__price">69 999 FCFA/ <span>ans</span></div>
                                <h3 class="packages-one__card__title">Offre Access</h3>
                                <ul class="packages-one__card__list">
                                    <li><span class="fas fa-check"></span>Câble réseau</li>
                                    <li><span class="fas fa-check"></span>Configuration répéteur</li>
                                    <li><span class="fas fa-check"></span>Configuration appareils connectés</li>
                                    <li><span class="fas fa-check"></span>1 répéteur offert</li>
                                    <li><span class="fas fa-check"></span>1 smart interrupteur offert</li>
                                    <li><span class="fas fa-check"></span>SAV 03 mois offert</li>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="packages-one__card">
                                <div class="packages-one__card__price">160 999 FCFA/ <span>ans</span></div>
                                <h3 class="packages-one__card__title">Offre Confort</h3>
                                <ul class="packages-one__card__list">
                                    <li><span class="fas fa-check"></span>Câble réseau</li>
                                    <li><span class="fas fa-check"></span>Configuration AP</li>
                                    <li><span class="fas fa-check"></span>Configuration appareils connectés</li>
                                    <li><span class="fas fa-check"></span>1 firewal offert</li>
                                    <li><span class="fas fa-check"></span>1 AP offert</li>
                                    <li><span class="fas fa-check"></span>1 notion sur les bases de la cyber sécurité</li>
    ...
    <section class="feature-one">
        <div class="container">
            <div class="sec-title text-center">
                <h6 class="sec-title__tagline bw-split-in-right">
                    <span class="sec-title__tagline__left-border"></span>Nos Atouts<span
                        class="sec-title__tagline__right-border"></span>
                </h6>
